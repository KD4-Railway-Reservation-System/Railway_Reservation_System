...
export const trainApi = {
  ...
  searchTrains: (sourceId, destId) => 
    axiosClient.get(`/api/trains/search?sourceStationId=${sourceId}&destinationStationId=${destId}`),
...
export const bookingApi = {
  bookTicket: (userId, data) => axiosClient.post(`/api/bookings?userId=${userId}`, data),
...
export const notificationApi = {
  sendBookingConfirmation: (data) => axiosClient.post('/api/notifications/booking-confirmation', data),
  sendCancellationNotice: (data) => axiosClient.post('/api/notifications/cancellation', data),
};
